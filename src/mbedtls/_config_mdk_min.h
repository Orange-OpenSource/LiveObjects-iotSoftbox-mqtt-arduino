...
#define MBEDTLS_CONFIG_NAME  "MDK_MIN_170220"
...
/* SSL options */
#define MBEDTLS_SSL_MAX_CONTENT_LEN          (3*1024) /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
