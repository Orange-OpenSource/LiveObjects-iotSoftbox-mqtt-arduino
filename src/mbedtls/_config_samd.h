...
#define MBEDTLS_CONFIG_NAME  "SAMD_170220"
...
/* SSL options */
#define MBEDTLS_SSL_MAX_CONTENT_LEN            (2890) /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
